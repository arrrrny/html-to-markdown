...
// alef:hash:09133d1b2d4d840759c5ea259edee65302eb1db80a9f02dec9212f129898dd2e
...
final class RealWorldTests: XCTestCase {
    func testRealWorldBlogPost() throws {
        ...
        XCTAssertTrue(result.content.contains("# Getting Started with Rust"), "expected to contain: \("# Getting Started with Rust")")
        XCTAssertTrue(result.content.contains("## Installation"), "expected to contain: \("## Installation")")
        XCTAssertTrue(result.content.contains("## Hello World"), "expected to contain: \("## Hello World")")
        XCTAssertTrue(result.content.contains("## Key Concepts"), "expected to contain: \("## Key Concepts")")
        XCTAssertTrue(result.content.contains("cargo run"), "expected to contain: \("cargo run")")
        XCTAssertTrue(result.content.contains("[Mozilla](https://www.mozilla.org)"), "expected to contain: \("[Mozilla](https://www.mozilla.org)")")
        XCTAssertTrue(result.content.contains("- Ownership and borrowing"), "expected to contain: \("- Ownership and borrowing")")
    }
    ...
    func testRealWorldDocumentationPage() throws {
        ...
        XCTAssertFalse(result.content.isEmpty, "expected non-empty value")
        XCTAssertTrue(result.content.contains("# API Reference"), "expected to contain: \("# API Reference")")
        XCTAssertTrue(result.content.contains("## convert_html"), "expected to contain: \("## convert_html")")
        XCTAssertTrue(result.content.contains("### Parameters"), "expected to contain: \("### Parameters")")
        XCTAssertTrue(result.content.contains("### Returns"), "expected to contain: \("### Returns")")
        XCTAssertTrue(result.content.contains("### Example"), "expected to contain: \("### Example")")
        XCTAssertTrue(result.content.contains("## ConversionOptions"), "expected to contain: \("## ConversionOptions")")
        XCTAssertTrue(result.content.contains("> "), "expected to contain: \("> ")")
        XCTAssertTrue(result.content.contains("thread-safe"), "expected to contain: \("thread-safe")")
        XCTAssertTrue(result.content.contains("convert_html"), "expected to contain: \("convert_html")")
        XCTAssertTrue(result.content.contains("ConversionOptions"), "expected to contain: \("ConversionOptions")")
    }
    ...
    func testRealWorldProductPage() throws {
        ...
        XCTAssertFalse(result.content.isEmpty, "expected non-empty value")
        XCTAssertTrue(result.content.contains("# Wireless Keyboard Pro"), "expected to contain: \("# Wireless Keyboard Pro")")
        XCTAssertTrue(result.content.contains("![Wireless Keyboard Pro](https://example.com/keyboard.jpg)"), "expected to contain: \("![Wireless Keyboard Pro](https://example.com/keyboard.jpg)")")
        XCTAssertTrue(result.content.contains("## Specifications"), "expected to contain: \("## Specifications")")
        XCTAssertTrue(result.content.contains("Battery Life"), "expected to contain: \("Battery Life")")
        XCTAssertTrue(result.content.contains("12 months"), "expected to contain: \("12 months")")
        XCTAssertTrue(result.content.contains("Bluetooth 5.0"), "expected to contain: \("Bluetooth 5.0")")
        XCTAssertTrue(result.content.contains("## What's in the Box"), "expected to contain: \("## What's in the Box")")
        XCTAssertTrue(result.content.contains("USB-C charging cable"), "expected to contain: \("USB-C charging cable")")
        XCTAssertTrue(result.content.contains("|"), "expected to contain: \("|")")
        XCTAssertTrue(result.content.contains("---"), "expected to contain: \("---")")
    }
