...
// alef:hash:5b33488ccab7dbdf725dddc0b39f5ab2281b871be263aba9c35977272b36a005
...
func Test_MetadataLangAttribute(t *testing.T) {
	...
	result, err := htmd.Convert(`<html lang="es"><head><title>Spanish Page</title></head><body><h1>Hola Mundo</h1><p>Este es un documento en español.</p></body></html>`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	var content string
...
func Test_MetadataMicrodataSchemaOrganization(t *testing.T) {
	...
	result, err := htmd.Convert(`<html><head><title>Company</title></head><body><div itemscope itemtype="https://schema.org/Organization"><span itemprop="name">Acme Corp</span><span itemprop="foundingDate">2020</span><span itemprop="url">https://acmecorp.example.com</span><span itemprop="logo">https://acmecorp.example.com/logo.png</span></div></body></html>`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	var content string
...
func Test_MetadataMicrodataSchemaPerson(t *testing.T) {
	...
	result, err := htmd.Convert(`<html><head><title>Contact</title></head><body><div itemscope itemtype="https://schema.org/Person"><span itemprop="name">John Smith</span><span itemprop="email">john@example.com</span><span itemprop="telephone">+1-555-0100</span></div></body></html>`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	var content string
...
func Test_MetadataTextDirectionLtr(t *testing.T) {
	...
	result, err := htmd.Convert(`<html lang="en" dir="ltr"><head><title>LTR Document</title></head><body><p>This is left-to-right text.</p></body></html>`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	var content string
...
func Test_MetadataTextDirectionRtl(t *testing.T) {
	...
	result, err := htmd.Convert(`<html lang="ar" dir="rtl"><head><title>RTL Document</title></head><body><p>This is right-to-left text.</p></body></html>`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	var content string
