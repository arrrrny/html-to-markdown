...
// alef:hash:c9c59ce637e1e63f280413056a62b61a0e9a79c859dad0ffc82ad33c14668c2b
...
assert_eq!(markdown, "# Hello");</code></pre><h2>ConversionOptions</h2><p>Configure conversion behavior using the builder pattern:</p><pre><code class="language-rust">let options = ConversionOptions::builder()
    ...
    .build();</code></pre><blockquote><p>See the <a href="/docs/options">options reference</a> for a full list of configuration values.</p></blockquote></div>`, htmd.ConversionOptions{})
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
}
...
func Test_RealWorldProductPage(t *testing.T) {
	...
	err := htmd.Convert(`<div class="product"><h1>Wireless Keyboard Pro</h1><img src="https://example.com/keyboard.jpg" alt="Wireless Keyboard Pro"><p>The ultimate wireless keyboard for professionals. Features a comfortable layout with <strong>backlit keys</strong> and <em>ultra-long battery life</em>.</p><h2>Specifications</h2><table><thead><tr><th>Feature</th><th>Details</th></tr></thead><tbody><tr><td>Battery Life</td><td>Up to 12 months</td></tr><tr><td>Connectivity</td><td>Bluetooth 5.0</td></tr><tr><td>Key Travel</td><td>2mm</td></tr><tr><td>Weight</td><td>750g</td></tr></tbody></table><h2>What's in the Box</h2><ul><li>Wireless Keyboard Pro</li><li>USB-C charging cable</li><li>USB receiver dongle</li><li>Quick start guide</li></ul><h2>Compatibility</h2><p>Compatible with <strong>Windows</strong>, <strong>macOS</strong>, <strong>Linux</strong>, <strong>iOS</strong>, and <strong>Android</strong>.</p></div>`, htmd.ConversionOptions{})
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
}
