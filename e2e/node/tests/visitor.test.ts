...
// alef:hash:985efb424fa4d9793b1c860292498d4d0f47c369bb10d4ac03f9b610ab7e3f6a
...
describe("visitor", () => {
  ...
  it("visitor_continue_default: Visitor continue action preserves default conversion", () => {
    ...
    const result = convert("<p>Hello <strong>World</strong></p>", undefined, {
      visitor: _testVisitor,
    });
  ...
  it("visitor_custom_blockquote: Visitor replaces blockquote with custom format", () => {
    ...
    const result = convert("<blockquote><p>A wise quote.</p></blockquote>", undefined, {
      visitor: _testVisitor,
    });
  ...
  it("visitor_custom_emphasis: Visitor replaces emphasis with custom output", () => {
    ...
    const result = convert("<p>This is <em>important</em> text.</p>", undefined, {
      visitor: _testVisitor,
    });
  ...
  it("visitor_custom_heading: Visitor replaces heading with custom format", () => {
    ...
    const result = convert("<h2>Section Title</h2><p>Content below heading.</p>", undefined, {
      visitor: _testVisitor,
    });
  ...
  it("visitor_custom_image: Visitor replaces image with custom output using template", () => {
    ...
    const result = convert('<img src="banner.png" alt="Banner">', undefined, {
      visitor: _testVisitor,
    });
  ...
  it("visitor_custom_link_static: Visitor replaces link with static custom output", () => {
    ...
    const result = convert('<a href="https://example.com">Click here</a>', undefined, {
      visitor: _testVisitor,
    });
  ...
  it("visitor_custom_output: Visitor custom action replaces element output", () => {
    ...
    const result = convert("<h1>Original Heading</h1>", undefined, { visitor: _testVisitor });
...
`,
  ...
  it("visitor_horizontal_rule_skip: Visitor removes all horizontal rules", () => {
    ...
    const result = convert("<p>Part 1</p><hr><p>Part 2</p><hr><p>Part 3</p>", undefined, {
      visitor: _testVisitor,
    });
  ...
  it("visitor_line_break_custom: Visitor replaces line break with custom output", () => {
    ...
    const result = convert("<p>First line<br>Second line<br>Third line</p>", undefined, {
      visitor: _testVisitor,
    });
  ...
  it("visitor_line_break_skip: Visitor removes all line breaks", () => {
    ...
    const result = convert("<p>Address Line 1<br>Address Line 2<br>Address Line 3</p>", undefined, {
      visitor: _testVisitor,
    });
  ...
  it("visitor_preserve_html: Visitor preserve_html action includes raw HTML in output", () => {
    ...
    const result = convert("<div><custom-tag>Custom content</custom-tag></div>", undefined, {
      visitor: _testVisitor,
    });
  ...
  it("visitor_skip_all_headings: Visitor skips all headings from document", () => {
    ...
    const result = convert("<h1>Title</h1><p>Body text remains.</p>", undefined, {
      visitor: _testVisitor,
    });
  ...
  it("visitor_skip_strong: Visitor skips bold/strong elements", () => {
    ...
    const result = convert("<p>Normal <strong>bold text</strong> normal</p>", undefined, {
      visitor: _testVisitor,
    });
  ...
  it("visitor_subscript_custom: Visitor replaces subscript with custom template", () => {
    ...
    const result = convert("<p>H<sub>2</sub>O is water.</p>", undefined, { visitor: _testVisitor });
  ...
  it("visitor_underline_custom: Visitor replaces underline with custom markup", () => {
    ...
    const result = convert("<p>This is <u>very important</u> text.</p>", undefined, {
      visitor: _testVisitor,
    });
