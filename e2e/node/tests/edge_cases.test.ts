...
// alef:hash:81eb4b4b3080c4d0b70d8bf005faa6a923adc88623ff5d1a071a256424b366d0
...
describe("edge-cases", () => {
  ...
  it("visitor_element_end_modification: Visitor modifies element at end after children processed", () => {
    ...
    const result = convert("<blockquote><p>Original quote</p></blockquote>", undefined, {
      visitor: _testVisitor,
    });
    expect((result.content ?? "").length).toBeGreaterThan(0);
  });
  ...
  it("visitor_element_start_skip_entire_subtree: Visitor skips at element_start level removes entire subtree", () => {
    ...
    const result = convert("<div><h1>Title</h1><p>Content</p></div>", undefined, {
      visitor: _testVisitor,
    });
