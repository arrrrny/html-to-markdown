...
// alef:hash:971ee7df6329f282b672b95dcf588f196749ae9b0b6fca8b537b0e6e883c1801
...
void test_blockquote_multiple_paragraphs(void) {
    ...
    HTMHtmConvert* result = htm_convert("<blockquote><p>First paragraph.</p><p>Second paragraph.</p></blockquote>", NULL);
...
void test_blockquote_nested(void) {
    ...
    HTMHtmConvert* result = htm_convert("<blockquote><p>Outer quote.</p><blockquote><p>Inner quote.</p></blockquote></blockquote>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_blockquote_simple(void) {
    /* Simple blockquote */
    HTMHtmConvert* result = htm_convert("<blockquote><p>Quote text</p></blockquote>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_blockquote_with_list(void) {
    ...
    HTMHtmConvert* result = htm_convert("<blockquote><p>Quote intro:</p><ul><li>Point one</li><li>Point two</li></ul></blockquote>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_bold_and_italic(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p><strong><em>both</em></strong></p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_bold_strong(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p><strong>bold</strong></p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_code_block(void) {
    ...
    HTMHtmConvert* result = htm_convert("<pre><code class=\"language-python\">print('hello')</code></pre>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_code_block_no_language(void) {
    ...
    HTMHtmConvert* result = htm_convert("<pre><code>plain code here</code></pre>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_code_inline_in_paragraph(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>Call the <code>initialize()</code> method first.</p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_code_with_backticks_in_content(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>Use <code>`backtick` here</code> carefully.</p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_emphasis_mark_highlight(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p><mark>highlighted</mark></p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_emphasis_strikethrough_del(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p><del>deleted text</del></p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_emphasis_strikethrough_s(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p><s>strikethrough</s></p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_emphasis_subscript(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>H<sub>2</sub>O</p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_emphasis_superscript(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>x<sup>2</sup></p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_emphasis_underline_u(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p><u>underlined</u></p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_form_input_elements(void) {
    ...
    HTMHtmConvert* result = htm_convert("<form><label for=\"name\">Name:</label><input type=\"text\" id=\"name\" placeholder=\"Enter name\"></form>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_form_select_options(void) {
    ...
    HTMHtmConvert* result = htm_convert("<form><label>Color:</label><select><option value=\"red\">Red</option><option value=\"blue\" selected>Blue</option><option value=\"green\">Green</option></select></form>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_form_textarea(void) {
    ...
    HTMHtmConvert* result = htm_convert("<form><label>Message:</label><textarea>Default text content</textarea></form>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_heading_h1(void) {
    /* H1 heading */
    HTMHtmConvert* result = htm_convert("<h1>Heading 1</h1>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_heading_h2(void) {
    /* H2 heading */
    HTMHtmConvert* result = htm_convert("<h2>Heading 2</h2>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_heading_h3(void) {
    /* H3 heading */
    HTMHtmConvert* result = htm_convert("<h3>Heading 3</h3>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_heading_h4(void) {
    /* H4 heading */
    HTMHtmConvert* result = htm_convert("<h4>Heading 4</h4>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_heading_h5(void) {
    /* H5 heading */
    HTMHtmConvert* result = htm_convert("<h5>Heading 5</h5>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_heading_h6(void) {
    /* H6 heading */
    HTMHtmConvert* result = htm_convert("<h6>Heading 6</h6>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_image_figure_figcaption(void) {
    ...
    HTMHtmConvert* result = htm_convert("<figure><img src=\"sunset.jpg\" alt=\"A sunset\"><figcaption>Beautiful sunset over the ocean</figcaption></figure>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_image_linked(void) {
    ...
    HTMHtmConvert* result = htm_convert("<a href=\"https://example.com\"><img src=\"icon.png\" alt=\"Icon\"></a>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_image_no_alt(void) {
    ...
    HTMHtmConvert* result = htm_convert("<img src=\"banner.jpg\">", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_image_simple(void) {
    /* Image with alt text */
    HTMHtmConvert* result = htm_convert("<img src=\"photo.jpg\" alt=\"A photo\">", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_image_with_title(void) {
    ...
    HTMHtmConvert* result = htm_convert("<img src=\"chart.png\" alt=\"Sales chart\" title=\"Q3 Sales\">", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_inline_code(void) {
    /* Inline code */
    HTMHtmConvert* result = htm_convert("<p>Use <code>console.log()</code> to debug</p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_italic_em(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p><em>italic</em></p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_line_break_br_tag(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>First line.<br>Second line.</p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_line_break_hr_tag(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>Before rule.</p><hr><p>After rule.</p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_line_break_multiple_br(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>Start.<br><br>End.</p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_link_anchor_fragment(void) {
    ...
    HTMHtmConvert* result = htm_convert("<a href=\"#section\">Jump to section</a>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_link_empty_href(void) {
    ...
    HTMHtmConvert* result = htm_convert("<a href=\"\">No destination</a>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_link_image_inside(void) {
    ...
    HTMHtmConvert* result = htm_convert("<a href=\"https://example.com\"><img src=\"logo.png\" alt=\"Logo\"></a>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_link_mailto(void) {
    ...
    HTMHtmConvert* result = htm_convert("<a href=\"mailto:user@example.com\">Email us</a>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_link_simple(void) {
    /* Simple link */
    HTMHtmConvert* result = htm_convert("<a href=\"https://example.com\">Example</a>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_link_with_bold_text(void) {
    ...
    HTMHtmConvert* result = htm_convert("<a href=\"https://example.com\"><strong>Bold link</strong></a>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_link_with_title(void) {
    ...
    HTMHtmConvert* result = htm_convert("<a href=\"https://example.com\" title=\"Example Site\">Example</a>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strstr(content, "[Example](https://example.com") != NULL && "expected to contain substring");
...
void test_list_definition_dl(void) {
    ...
    HTMHtmConvert* result = htm_convert("<dl><dt>Term One</dt><dd>Definition of term one.</dd><dt>Term Two</dt><dd>Definition of term two.</dd></dl>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_list_item_multiple_paragraphs(void) {
    ...
    HTMHtmConvert* result = htm_convert("<ul><li><p>First paragraph in item.</p><p>Second paragraph in item.</p></li><li>Simple item</li></ul>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_list_mixed_nested(void) {
    ...
    HTMHtmConvert* result = htm_convert("<ul><li>Item A<ol><li>Sub 1</li><li>Sub 2</li></ol></li><li>Item B</li></ul>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_list_nested_ordered(void) {
    ...
    HTMHtmConvert* result = htm_convert("<ol><li>Step 1<ol><li>Step 1a</li><li>Step 1b</li></ol></li><li>Step 2</li></ol>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_list_nested_unordered(void) {
    ...
    HTMHtmConvert* result = htm_convert("<ul><li>Parent A<ul><li>Child A1</li><li>Child A2</li></ul></li><li>Parent B</li></ul>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_list_task_checkboxes(void) {
    ...
    HTMHtmConvert* result = htm_convert("<ul><li><input type=\"checkbox\" checked> Done task</li><li><input type=\"checkbox\"> Pending task</li></ul>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_ordered_list(void) {
    /* Ordered list */
    HTMHtmConvert* result = htm_convert("<ol><li>First</li><li>Second</li><li>Third</li></ol>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_paragraph_multiple(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>First paragraph.</p><p>Second paragraph.</p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strstr(content, "First paragraph.") != NULL && "expected to contain substring");
    assert(strstr(content, "Second paragraph.") != NULL && "expected to contain substring");
...
void test_paragraph_nested_divs(void) {
    ...
    HTMHtmConvert* result = htm_convert("<div><div><p>Nested text</p></div></div>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_paragraph_with_inline_formatting(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>This has <strong>bold</strong>, <em>italic</em>, and a <a href=\"https://example.com\">link</a>.</p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strstr(content, "**bold**") != NULL && "expected to contain substring");
    assert(strstr(content, "*italic*") != NULL && "expected to contain substring");
...
void test_paragraph_with_line_breaks(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>Line one.<br>Line two.<br>Line three.</p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_semantic_abbr(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>The <abbr title=\"World Wide Web\">WWW</abbr> is global.</p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_semantic_article(void) {
    ...
    HTMHtmConvert* result = htm_convert("<article><h2>Article Title</h2><p>Article body.</p></article>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_semantic_definition_list(void) {
    ...
    HTMHtmConvert* result = htm_convert("<dl><dt>HTML</dt><dd>HyperText Markup Language</dd><dt>CSS</dt><dd>Cascading Style Sheets</dd></dl>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_semantic_details_summary(void) {
    ...
    HTMHtmConvert* result = htm_convert("<details><summary>Click to expand</summary><p>Hidden content here.</p></details>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_semantic_hr(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>Above</p><hr><p>Below</p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_semantic_mark_highlight(void) {
    /* Mark tag produces highlighted output */
    HTMHtmConvert* result = htm_convert("<p>This is <mark>highlighted text</mark> in a sentence.</p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_semantic_section_with_heading(void) {
    ...
    HTMHtmConvert* result = htm_convert("<section><h3>Section Heading</h3><p>Section content.</p></section>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_semantic_sub_superscript(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>H<sub>2</sub>O and E=mc<sup>2</sup></p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
    assert(strstr(content, "H") != NULL && "expected to contain substring");
...
void test_simple_table(void) {
    ...
    HTMHtmConvert* result = htm_convert("<table><thead><tr><th>Name</th><th>Age</th></tr></thead><tbody><tr><td>Alice</td><td>30</td></tr></tbody></table>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strstr(content, "Name") != NULL && "expected to contain substring");
...
void test_table_empty(void) {
    ...
    HTMHtmConvert* result = htm_convert("<table></table>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_table_no_thead(void) {
    ...
    HTMHtmConvert* result = htm_convert("<table><tr><td>Product</td><td>Price</td></tr><tr><td>Apple</td><td>1.00</td></tr></table>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_table_pipe_chars_in_content(void) {
    ...
    HTMHtmConvert* result = htm_convert("<table><thead><tr><th>Expression</th><th>Result</th></tr></thead><tbody><tr><td>a | b</td><td>true</td></tr></tbody></table>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_table_with_alignment(void) {
    ...
    HTMHtmConvert* result = htm_convert("<table><thead><tr><th align=\"left\">Left</th><th align=\"center\">Center</th><th align=\"right\">Right</th></tr></thead><tbody><tr><td>L</td><td>C</td><td>R</td></tr></tbody></table>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_table_with_colspan(void) {
    ...
    HTMHtmConvert* result = htm_convert("<table><thead><tr><th colspan=\"2\">Full Name</th></tr></thead><tbody><tr><td>John</td><td>Doe</td></tr></tbody></table>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_unordered_list(void) {
    /* Unordered list */
    HTMHtmConvert* result = htm_convert("<ul><li>Item 1</li><li>Item 2</li><li>Item 3</li></ul>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
