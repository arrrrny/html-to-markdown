...
// alef:hash:50a6d7b48c5d2c8ca4704f00ee5bd22a4be043f00a5a8bd2c5a2d0a6064a471d
...
void test_options_autolinks_false(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p><a href='https://example.com'>https://example.com</a></p>", options_handle);
...
void test_options_br_in_tables_false(void) {
    ...
    HTMHtmConvert* result = htm_convert("<table><tr><th>Col</th></tr><tr><td>A<br>B</td></tr></table>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_br_in_tables_true(void) {
    ...
    HTMHtmConvert* result = htm_convert("<table><tr><th>Header</th></tr><tr><td>Line 1<br>Line 2</td></tr></table>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_code_block_indented(void) {
    ...
    HTMHtmConvert* result = htm_convert("<pre><code>print('hello')</code></pre>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_code_block_tildes(void) {
    ...
    HTMHtmConvert* result = htm_convert("<pre><code>let x = 1;</code></pre>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strstr(content, "~~~") != NULL && "expected to contain substring");
...
void test_options_code_language_python(void) {
    ...
    HTMHtmConvert* result = htm_convert("<pre><code>def hello(): pass</code></pre>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_convert_as_inline(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>One</p><p>Two</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_debug_true(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>Debug test</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_default_title_true(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p><a href='https://example.com'>Link</a></p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_encoding_utf8(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>Café naïve résumé</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_escape_ascii_enabled(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>Text with # hash and [brackets] and * star</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_exclude_selectors_attribute(void) {
    ...
    HTMHtmConvert* result = htm_convert("<body><div role=\"complementary\">Sidebar</div><p>Primary text</p></body>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_exclude_selectors_class(void) {
    ...
    HTMHtmConvert* result = htm_convert("<body><div class=\"cookie-banner\">Accept cookies</div><p>Main content</p></body>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_exclude_selectors_empty_noop(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>Hello world</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_exclude_selectors_id(void) {
    ...
    HTMHtmConvert* result = htm_convert("<body><div id=\"ad-container\">Buy stuff</div><p>Article text</p></body>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_exclude_selectors_multiple(void) {
    ...
    HTMHtmConvert* result = htm_convert("<body><nav class=\"nav\">Menu</nav><p>Content</p><footer>Footer</footer></body>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_exclude_selectors_nested_content_dropped(void) {
    ...
    HTMHtmConvert* result = htm_convert("<body><aside class=\"sidebar\"><h2>Related</h2><p>Sidebar text</p></aside><main><p>Main text</p></main></body>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_exclude_selectors_plain_text_mode(void) {
    ...
    HTMHtmConvert* result = htm_convert("<body><div class=\"nav\">Navigation</div><p>Article body</p></body>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_exclude_selectors_vs_strip_tags(void) {
    ...
    HTMHtmConvert* result = htm_convert("<body><div class=\"wrapper\"><p>Inner paragraph</p></div><p>Outer text</p></body>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_extract_metadata_true(void) {
    ...
    HTMHtmConvert* result = htm_convert("<html><head><title>Test Page</title><meta name='description' content='A test page'></head><body><p>Content</p></body></html>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_highlight_bold(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>Text with <mark>highlighted</mark> text.</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_highlight_double_equal(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>Text with <mark>highlighted</mark> here.</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strstr(content, "==highlighted==") != NULL && "expected to contain substring");
    htm_free_string(content);
...
void test_options_highlight_none(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>Text with <mark>plain</mark> content.</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_keep_inline_images_in_paragraph(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>Text <img src='icon.png' alt='icon'> more text</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strstr(content, "Text") != NULL && "expected to contain substring");
...
void test_options_link_style_reference(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p><a href='https://example.com'>Example</a> and <a href='https://other.com'>Other</a></p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_list_indent_width_four(void) {
    ...
    HTMHtmConvert* result = htm_convert("<ul><li>Outer<ul><li>Inner</li></ul></li></ul>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_newline_backslash(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>Line one<br>Line two</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_newline_spaces(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>First<br>Second</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_preprocessing_aggressive(void) {
    ...
    HTMHtmConvert* result = htm_convert("<nav>Menu</nav><article><h1>Title</h1><p>Content</p></article><aside>Sidebar</aside><footer>Footer</footer>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strstr(content, "Title") != NULL && "expected to contain substring");
    assert(strstr(content, "Content") != NULL && "expected to contain substring");
...
void test_options_preprocessing_minimal(void) {
    ...
    HTMHtmConvert* result = htm_convert("<nav>Navigation</nav><p>Content</p><footer>Footer</footer>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_preprocessing_remove_forms(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>Before</p><form><input type='text'/><button>Submit</button></form><p>After</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_preserve_tags_iframe(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>Before</p><iframe src='video.html' width='560'></iframe><p>After</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strstr(content, "Before") != NULL && "expected to contain substring");
    assert(strstr(content, "After") != NULL && "expected to contain substring");
...
void test_options_skip_images_true(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>Before <img src='test.jpg' alt='photo'> After</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strstr(content, "Before") != NULL && "expected to contain substring");
    assert(strstr(content, "After") != NULL && "expected to contain substring");
...
void test_options_strip_newlines(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>First paragraph.</p><p>Second paragraph.</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_strip_tags_div_span(void) {
    ...
    HTMHtmConvert* result = htm_convert("<div class='wrapper'><p>Inside div</p></div><p>Outside <span class='hl'>span text</span></p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_strong_em_underscore(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p><strong>bold</strong> and <em>italic</em></p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
...
void test_options_sub_symbol_tilde(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>H<sub>2</sub>O</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strstr(content, "~2~") != NULL && "expected to contain substring");
    htm_free_string(content);
...
void test_options_sup_symbol_caret(void) {
    ...
    HTMHtmConvert* result = htm_convert("<p>x<sup>2</sup></p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_htm_convert_content(result);
    assert(strstr(content, "^2^") != NULL && "expected to contain substring");
    htm_free_string(content);
