...
// alef:hash:7a21a45a92e5933c842c349e20d514fbba355c774cc8cb2bee9e898e17e2f5a9
...
class MetadataTest {
    ...
    void testMetadataLangAttribute() throws Exception {
        ...
        var result = HtmlToMarkdown.convert("<html lang=\"es\"><head><title>Spanish Page</title></head><body><h1>Hola Mundo</h1><p>Este es un documento en español.</p></body></html>");
        assertFalse(result.content().orElse("").isEmpty(), "expected non-empty value");
    ...
    void testMetadataMicrodataSchemaOrganization() throws Exception {
        ...
        var result = HtmlToMarkdown.convert("<html><head><title>Company</title></head><body><div itemscope itemtype=\"https://schema.org/Organization\"><span itemprop=\"name\">Acme Corp</span><span itemprop=\"foundingDate\">2020</span><span itemprop=\"url\">https://acmecorp.example.com</span><span itemprop=\"logo\">https://acmecorp.example.com/logo.png</span></div></body></html>");
        assertFalse(result.content().orElse("").isEmpty(), "expected non-empty value");
    ...
    void testMetadataMicrodataSchemaPerson() throws Exception {
        ...
        var result = HtmlToMarkdown.convert("<html><head><title>Contact</title></head><body><div itemscope itemtype=\"https://schema.org/Person\"><span itemprop=\"name\">John Smith</span><span itemprop=\"email\">john@example.com</span><span itemprop=\"telephone\">+1-555-0100</span></div></body></html>");
        assertFalse(result.content().orElse("").isEmpty(), "expected non-empty value");
    ...
    void testMetadataTextDirectionLtr() throws Exception {
        ...
        var result = HtmlToMarkdown.convert("<html lang=\"en\" dir=\"ltr\"><head><title>LTR Document</title></head><body><p>This is left-to-right text.</p></body></html>");
        assertFalse(result.content().orElse("").isEmpty(), "expected non-empty value");
    ...
    void testMetadataTextDirectionRtl() throws Exception {
        ...
        var result = HtmlToMarkdown.convert("<html lang=\"ar\" dir=\"rtl\"><head><title>RTL Document</title></head><body><p>This is right-to-left text.</p></body></html>");
        assertFalse(result.content().orElse("").isEmpty(), "expected non-empty value");
