...
// alef:hash:8d1ab3425cc06eb6926a9406bc15efd8ce6981e940be9b45d2b243c1231b1a4e
...
class EdgeCasesTest {
    ...
    void testVisitorCustomElementWithNesting() throws Exception {
        ...
        var result = HtmlToMarkdown.convert("<div><custom-widget data-value=\"123\"><p>Widget content here</p><span>With nested elements</span></custom-widget></div>", visitor);
    ...
    void testVisitorDeeplyNestedSkip() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<div><p>Outer <em>emphasis <strong>with bold <mark>and highlight</mark></strong></em> text</p></div>", visitor);
    ...
    void testVisitorElementEndModification() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<blockquote><p>Original quote</p></blockquote>", visitor);
        assertFalse(result.content().orElse("").isEmpty(), "expected non-empty value");
    }
    ...
    void testVisitorElementStartSkipEntireSubtree() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<div><h1>Title</h1><p>Content</p></div>", visitor);
        assertFalse(result.content().orElse("").isEmpty(), "expected non-empty value");
    }
    ...
    void testVisitorUnknownTagPreservation() throws Exception {
        ...
        var visitor = new _TestVisitor();
        var result = HtmlToMarkdown.convert("<article><p>Article text</p><x-custom>Custom element with content</x-custom><p>More article text</p></article>", visitor);
