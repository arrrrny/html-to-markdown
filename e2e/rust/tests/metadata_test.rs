...
// alef:hash:4abbda766bc032a098c858953c893b7f6150d1d412c2da4828e615b56e5c6e13
...
fn test_metadata_dublin_core() {
    ...
    assert!(format!("{:?}", content).contains(r#"scholarly article"#), "expected to contain: {}", r#"scholarly article"#);
}
...
fn test_metadata_lang_attribute() {
    ...
    let content = result.content.as_deref().unwrap_or("");
    assert!(!content.is_empty(), "expected non-empty value");
    assert!(format!("{:?}", content).contains(r#"Hola Mundo"#), "expected to contain: {}", r#"Hola Mundo"#);
}
...
fn test_metadata_microdata_schema_article() {
    ...
    let content = result.content.as_deref().unwrap_or("");
    assert!(!content.is_empty(), "expected non-empty value");
    assert!(format!("{:?}", content).contains(r#"Breaking News Today"#), "expected to contain: {}", r#"Breaking News Today"#);
    assert!(format!("{:?}", content).contains(r#"Jane Reporter"#), "expected to contain: {}", r#"Jane Reporter"#);
    assert!(format!("{:?}", content).contains(r#"important information"#), "expected to contain: {}", r#"important information"#);
}
...
fn test_metadata_microdata_schema_breadcrumb() {
    ...
    let content = result.content.as_deref().unwrap_or("");
    assert!(!content.is_empty(), "expected non-empty value");
    assert!(format!("{:?}", content).contains(r#"Home"#), "expected to contain: {}", r#"Home"#);
    assert!(format!("{:?}", content).contains(r#"Products"#), "expected to contain: {}", r#"Products"#);
    assert!(format!("{:?}", content).contains(r#"Current Page"#), "expected to contain: {}", r#"Current Page"#);
}
...
fn test_metadata_microdata_schema_organization() {
    ...
    let content = result.content.as_deref().unwrap_or("");
    assert!(!content.is_empty(), "expected non-empty value");
    assert!(format!("{:?}", content).contains(r#"Acme Corp"#), "expected to contain: {}", r#"Acme Corp"#);
    assert!(format!("{:?}", content).contains(r#"2020"#), "expected to contain: {}", r#"2020"#);
}
...
fn test_metadata_microdata_schema_person() {
    ...
    let content = result.content.as_deref().unwrap_or("");
    assert!(!content.is_empty(), "expected non-empty value");
    assert!(format!("{:?}", content).contains(r#"John Smith"#), "expected to contain: {}", r#"John Smith"#);
    assert!(format!("{:?}", content).contains(r#"john@example.com"#), "expected to contain: {}", r#"john@example.com"#);
}
...
fn test_metadata_microdata_schema_product() {
    ...
    let content = result.content.as_deref().unwrap_or("");
    assert!(!content.is_empty(), "expected non-empty value");
    assert!(format!("{:?}", content).contains(r#"Awesome Widget"#), "expected to contain: {}", r#"Awesome Widget"#);
    assert!(format!("{:?}", content).contains(r#"best widget"#), "expected to contain: {}", r#"best widget"#);
    assert!(format!("{:?}", content).contains(r#"29.99"#), "expected to contain: {}", r#"29.99"#);
}
...
fn test_metadata_text_direction_ltr() {
    ...
    let content = result.content.as_deref().unwrap_or("");
    assert!(!content.is_empty(), "expected non-empty value");
    assert!(format!("{:?}", content).contains(r#"left-to-right text"#), "expected to contain: {}", r#"left-to-right text"#);
}
...
fn test_metadata_text_direction_rtl() {
    ...
    let content = result.content.as_deref().unwrap_or("");
    assert!(!content.is_empty(), "expected non-empty value");
    assert!(format!("{:?}", content).contains(r#"right-to-left text"#), "expected to contain: {}", r#"right-to-left text"#);
}
