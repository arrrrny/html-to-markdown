...
// alef:hash:3aa080910ec3e90110a2f45c1a3bd3a15617652a1bc0ac4d9e03d33239b7a08f
...
fn test_options_autolinks_false() {
    ...
    assert!(format!("{:?}", content).contains(r#"example.com"#), "expected to contain: {}", r#"example.com"#);
}
...
fn test_options_br_in_tables_false() {
    ...
    let result = convert(&html, &options).expect("should succeed");
    let content = result.content.as_deref().unwrap_or("");
    assert!(format!("{:?}", content).contains(r#"Col"#), "expected to contain: {}", r#"Col"#);
}
...
fn test_options_br_in_tables_true() {
    ...
    let result = convert(&html, &options).expect("should succeed");
    let content = result.content.as_deref().unwrap_or("");
    assert!(format!("{:?}", content).contains(r#"Header"#), "expected to contain: {}", r#"Header"#);
    assert!(format!("{:?}", content).contains(r#"Line 1"#), "expected to contain: {}", r#"Line 1"#);
    assert!(format!("{:?}", content).contains(r#"Line 2"#), "expected to contain: {}", r#"Line 2"#);
}
...
fn test_options_code_block_tildes() {
    ...
    let content = result.content.as_deref().unwrap_or("");
    assert!(format!("{:?}", content).contains(r#"~~~"#), "expected to contain: {}", r#"~~~"#);
    assert!(format!("{:?}", content).contains(r#"let x = 1;"#), "expected to contain: {}", r#"let x = 1;"#);
}
...
fn test_options_code_language_python() {
    ...
    assert!(format!("{:?}", content).contains(r#"def hello"#), "expected to contain: {}", r#"def hello"#);
}
...
fn test_options_convert_as_inline() {
    ...
    let result = convert(&html, &options).expect("should succeed");
    let content = result.content.as_deref().unwrap_or("");
    assert!(format!("{:?}", content).contains(r#"One"#), "expected to contain: {}", r#"One"#);
    assert!(format!("{:?}", content).contains(r#"Two"#), "expected to contain: {}", r#"Two"#);
}
...
fn test_options_debug_true() {
    ...
    let result = convert(&html, &options).expect("should succeed");
    let content = result.content.as_deref().unwrap_or("");
    assert!(format!("{:?}", content).contains(r#"Debug test"#), "expected to contain: {}", r#"Debug test"#);
}
...
fn test_options_default_title_true() {
    ...
    let result = convert(&html, &options).expect("should succeed");
    let content = result.content.as_deref().unwrap_or("");
    assert!(format!("{:?}", content).contains(r#"Link"#), "expected to contain: {}", r#"Link"#);
...
fn test_options_escape_ascii_enabled() {
    ...
    assert!(format!("{:?}", content).contains(r#"hash"#), "expected to contain: {}", r#"hash"#);
    assert!(format!("{:?}", content).contains(r#"brackets"#), "expected to contain: {}", r#"brackets"#);
    assert!(format!("{:?}", content).contains(r#"star"#), "expected to contain: {}", r#"star"#);
}
...
fn test_options_exclude_selectors_attribute() {
    ...
    let result = convert(&html, &options).expect("should succeed");
    let content = result.content.as_deref().unwrap_or("");
    assert!(format!("{:?}", content).contains(r#"Primary text"#), "expected to contain: {}", r#"Primary text"#);
    assert!(!format!("{:?}", content).contains(r#"Sidebar"#), "expected NOT to contain: {}", r#"Sidebar"#);
}
...
fn test_options_exclude_selectors_class() {
    ...
    let result = convert(&html, &options).expect("should succeed");
    let content = result.content.as_deref().unwrap_or("");
    assert!(format!("{:?}", content).contains(r#"Main content"#), "expected to contain: {}", r#"Main content"#);
    assert!(!format!("{:?}", content).contains(r#"cookies"#), "expected NOT to contain: {}", r#"cookies"#);
}
...
fn test_options_exclude_selectors_id() {
    ...
    let result = convert(&html, &options).expect("should succeed");
    let content = result.content.as_deref().unwrap_or("");
    assert!(format!("{:?}", content).contains(r#"Article text"#), "expected to contain: {}", r#"Article text"#);
    assert!(!format!("{:?}", content).contains(r#"Buy stuff"#), "expected NOT to contain: {}", r#"Buy stuff"#);
}
...
fn test_options_exclude_selectors_multiple() {
    ...
    let result = convert(&html, &options).expect("should succeed");
    let content = result.content.as_deref().unwrap_or("");
    assert!(format!("{:?}", content).contains(r#"Content"#), "expected to contain: {}", r#"Content"#);
    assert!(!format!("{:?}", content).contains(r#"Menu"#), "expected NOT to contain: {}", r#"Menu"#);
    assert!(!format!("{:?}", content).contains(r#"Footer"#), "expected NOT to contain: {}", r#"Footer"#);
}
...
fn test_options_exclude_selectors_nested_content_dropped() {
    ...
    let result = convert(&html, &options).expect("should succeed");
    let content = result.content.as_deref().unwrap_or("");
    assert!(format!("{:?}", content).contains(r#"Main text"#), "expected to contain: {}", r#"Main text"#);
    assert!(!format!("{:?}", content).contains(r#"Related"#), "expected NOT to contain: {}", r#"Related"#);
    assert!(!format!("{:?}", content).contains(r#"Sidebar text"#), "expected NOT to contain: {}", r#"Sidebar text"#);
}
...
fn test_options_exclude_selectors_plain_text_mode() {
    ...
    assert!(!format!("{:?}", content).contains(r#"Navigation"#), "expected NOT to contain: {}", r#"Navigation"#);
}
...
fn test_options_exclude_selectors_vs_strip_tags() {
    ...
    let result = convert(&html, &options).expect("should succeed");
    let content = result.content.as_deref().unwrap_or("");
    assert!(format!("{:?}", content).contains(r#"Outer text"#), "expected to contain: {}", r#"Outer text"#);
    assert!(!format!("{:?}", content).contains(r#"Inner paragraph"#), "expected NOT to contain: {}", r#"Inner paragraph"#);
}
...
fn test_options_extract_metadata_true() {
    ...
    assert!(result.content.is_some(), "expected content to be present");
    assert_eq!(metadata_document_title.trim(), r#"Test Page"#, "equals assertion failed");
    assert_eq!(metadata_document_description.trim(), r#"A test page"#, "equals assertion failed");
}
...
fn test_options_highlight_none() {
    ...
    let result = convert(&html, &options).expect("should succeed");
    let content = result.content.as_deref().unwrap_or("");
    assert!(format!("{:?}", content).contains(r#"plain"#), "expected to contain: {}", r#"plain"#);
    assert!(!format!("{:?}", content).contains(r#"=="#), "expected NOT to contain: {}", r#"=="#);
}
...
fn test_options_keep_inline_images_in_paragraph() {
    ...
    let content = result.content.as_deref().unwrap_or("");
    assert!(format!("{:?}", content).contains(r#"Text"#), "expected to contain: {}", r#"Text"#);
    assert!(format!("{:?}", content).contains(r#"more text"#), "expected to contain: {}", r#"more text"#);
}
...
fn test_options_link_style_reference() {
    ...
    assert!(format!("{:?}", content).contains(r#"Other"#), "expected to contain: {}", r#"Other"#);
    assert!(format!("{:?}", content).contains(r#"example.com"#), "expected to contain: {}", r#"example.com"#);
}
...
fn test_options_list_indent_width_four() {
    ...
    let result = convert(&html, &options).expect("should succeed");
    let content = result.content.as_deref().unwrap_or("");
    assert!(format!("{:?}", content).contains(r#"Outer"#), "expected to contain: {}", r#"Outer"#);
    assert!(format!("{:?}", content).contains(r#"Inner"#), "expected to contain: {}", r#"Inner"#);
}
...
fn test_options_max_depth_default_unlimited() {
    ...
    let result = convert(&html, &options).expect("should succeed");
    let content = result.content.as_deref().unwrap_or("");
    assert!(format!("{:?}", content).contains(r#"Deep content"#), "expected to contain: {}", r#"Deep content"#);
}
...
fn test_options_max_depth_truncates() {
    ...
    let result = convert(&html, &options).expect("should succeed");
    let content = result.content.as_deref().unwrap_or("");
    assert!(format!("{:?}", content).contains(r#"Shallow"#), "expected to contain: {}", r#"Shallow"#);
    assert!(!format!("{:?}", content).contains(r#"Too deep"#), "expected NOT to contain: {}", r#"Too deep"#);
}
...
fn test_options_newline_spaces() {
    ...
    let result = convert(&html, &options).expect("should succeed");
    let content = result.content.as_deref().unwrap_or("");
    assert!(format!("{:?}", content).contains(r#"First"#), "expected to contain: {}", r#"First"#);
    assert!(format!("{:?}", content).contains(r#"Second"#), "expected to contain: {}", r#"Second"#);
}
...
fn test_options_preprocessing_minimal() {
    ...
    let result = convert(&html, &options).expect("should succeed");
    let content = result.content.as_deref().unwrap_or("");
    assert!(format!("{:?}", content).contains(r#"Navigation"#), "expected to contain: {}", r#"Navigation"#);
    assert!(format!("{:?}", content).contains(r#"Content"#), "expected to contain: {}", r#"Content"#);
    assert!(format!("{:?}", content).contains(r#"Footer"#), "expected to contain: {}", r#"Footer"#);
}
...
fn test_options_preprocessing_remove_forms() {
    ...
    let result = convert(&html, &options).expect("should succeed");
    let content = result.content.as_deref().unwrap_or("");
    assert!(format!("{:?}", content).contains(r#"Before"#), "expected to contain: {}", r#"Before"#);
    assert!(format!("{:?}", content).contains(r#"After"#), "expected to contain: {}", r#"After"#);
...
fn test_options_preserve_tags_iframe() {
    ...
    assert!(format!("{:?}", content).contains(r#"Before"#), "expected to contain: {}", r#"Before"#);
    assert!(format!("{:?}", content).contains(r#"After"#), "expected to contain: {}", r#"After"#);
    assert!(format!("{:?}", content).contains(r#"<iframe"#), "expected to contain: {}", r#"<iframe"#);
}
...
fn test_options_skip_images_true() {
    ...
    assert!(format!("{:?}", content).contains(r#"Before"#), "expected to contain: {}", r#"Before"#);
    assert!(format!("{:?}", content).contains(r#"After"#), "expected to contain: {}", r#"After"#);
    assert!(!format!("{:?}", content).contains(r#"photo"#), "expected NOT to contain: {}", r#"photo"#);
}
...
fn test_options_strip_tags_div_span() {
    ...
    let result = convert(&html, &options).expect("should succeed");
    let content = result.content.as_deref().unwrap_or("");
    assert!(format!("{:?}", content).contains(r#"Inside div"#), "expected to contain: {}", r#"Inside div"#);
    assert!(format!("{:?}", content).contains(r#"span text"#), "expected to contain: {}", r#"span text"#);
}
...
fn test_options_strong_em_underscore() {
    ...
    let result = convert(&html, &options).expect("should succeed");
    let content = result.content.as_deref().unwrap_or("");
    assert!(format!("{:?}", content).contains(r#"__bold__"#), "expected to contain: {}", r#"__bold__"#);
    assert!(format!("{:?}", content).contains(r#"_italic_"#), "expected to contain: {}", r#"_italic_"#);
}
