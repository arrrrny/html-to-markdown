...
// alef:hash:695ac9330c7500032967d0209be9c43f34979bd96b2e9f4cc85eb253b5a753b9
...
#[derive(Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(transparent)]
pub struct JsVisitResult(pub serde_json::Value);

impl napi::bindgen_prelude::TypeName for JsVisitResult {
...
impl napi::bindgen_prelude::FromNapiValue for JsVisitResult {
...
impl napi::bindgen_prelude::ToNapiValue for JsVisitResult {
    unsafe fn to_napi_value(env: napi::sys::napi_env, val: Self) -> napi::Result<napi::sys::napi_value> {
        unsafe { napi::bindgen_prelude::ToNapiValue::to_napi_value(env, val.0) }
    }
}

impl napi::bindgen_prelude::ValidateNapiValue for JsVisitResult {}
...
impl From<JsVisitResult> for html_to_markdown_rs::VisitResult {
