...
// alef:hash:5b3408d3e81963ccab80dad98bea95e983dfbc8d51cf2a9bd6fc81cb3e3f5cfc
...
impl ConversionOptions {
    ...
    /// Set the visitor for custom element traversal.
    /// This method is needed because the visitor field is read-only via direct property access in PHP.
    /// Used primarily by e2e tests to inject visitor callbacks.
    pub fn set_visitor(&mut self, visitor: Option<&VisitorHandle>) {
        self.visitor = visitor.cloned();
    }
