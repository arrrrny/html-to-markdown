...
// alef:hash:aea18a940763fe6d04f5c075cea470ee96c4db1daec59578396b69d329313a25
 ...
 *
 * <p>Use [{@code ConversionOptions::builder()}] to construct, or [{@code Default::default()}] for
 * defaults.
 *
 * <p># Example
 *
 * <p>{@code }{@code text} use html_to_markdown_rs::ConversionOptions;
 *
 * <p>let options = ConversionOptions::builder() .heading_style(HeadingStyle::Atx) .wrap(true)
 * .wrap_width(100) .build(); {@code }{@code }
 */
