...
// alef:hash:ad6881e272be342856c6286f2669f1f0aa2449858dde7a00c335ff1fb4893dbd
...
/**
 * Allocates Panama FFM upcall stubs for a Visitor and assembles the C HTMHtmVisitorCallbacks struct
 * in native memory.
 */
final class VisitorBridge implements AutoCloseable {
  ...
  private long registerStubs1(final long offset) throws ReflectiveOperationException {
    ...
    // visit_element_start
    var stubVisitElementStart =
        LINKER.upcallStub(
            LOOKUP.bind(
                this,
                "handleVisitElementStart",
                MethodType.methodType(
                    int.class,
                    MemorySegment.class,
                    MemorySegment.class,
    ...
    off += ValueLayout.ADDRESS.byteSize();
    // visit_element_end
    var stubVisitElementEnd =
        LINKER.upcallStub(
            LOOKUP.bind(
                this,
                "handleVisitElementEnd",
                MethodType.methodType(
                    int.class,
                    MemorySegment.class,
                    MemorySegment.class,
    ...
    off += ValueLayout.ADDRESS.byteSize();
    // visit_code_block
    var stubVisitCodeBlock =
        LINKER.upcallStub(
            LOOKUP.bind(
                this,
                "handleVisitCodeBlock",
                MethodType.methodType(
                    int.class,
                    MemorySegment.class,
                    MemorySegment.class,
    ...
    off += ValueLayout.ADDRESS.byteSize();
    // visit_code_inline
    var stubVisitCodeInline =
        LINKER.upcallStub(
            LOOKUP.bind(
                this,
                "handleVisitCodeInline",
                MethodType.methodType(
                    int.class,
                    MemorySegment.class,
                    MemorySegment.class,
    ...
    off += ValueLayout.ADDRESS.byteSize();
    // visit_list_start
    var stubVisitListStart =
        LINKER.upcallStub(
            LOOKUP.bind(
                this,
                "handleVisitListStart",
                MethodType.methodType(
                    int.class,
                    MemorySegment.class,
                    MemorySegment.class,
  ...
  private long registerStubs2(final long offset) throws ReflectiveOperationException {
    ...
    off += ValueLayout.ADDRESS.byteSize();
    // visit_table_start
    var stubVisitTableStart =
        LINKER.upcallStub(
            LOOKUP.bind(
                this,
                "handleVisitTableStart",
                MethodType.methodType(
                    int.class,
                    MemorySegment.class,
                    MemorySegment.class,
    ...
    off += ValueLayout.ADDRESS.byteSize();
    // visit_strikethrough
    var stubVisitStrikethrough =
        LINKER.upcallStub(
            LOOKUP.bind(
                this,
                "handleVisitStrikethrough",
                MethodType.methodType(
                    int.class,
                    MemorySegment.class,
                    MemorySegment.class,
    ...
    off += ValueLayout.ADDRESS.byteSize();
    // visit_underline
    var stubVisitUnderline =
        LINKER.upcallStub(
            LOOKUP.bind(
                this,
                "handleVisitUnderline",
                MethodType.methodType(
                    int.class,
                    MemorySegment.class,
                    MemorySegment.class,
    ...
    off += ValueLayout.ADDRESS.byteSize();
    // visit_subscript
    var stubVisitSubscript =
        LINKER.upcallStub(
            LOOKUP.bind(
                this,
                "handleVisitSubscript",
                MethodType.methodType(
                    int.class,
                    MemorySegment.class,
                    MemorySegment.class,
  ...
  private long registerStubs3(final long offset) throws ReflectiveOperationException {
    long off = offset;
    // visit_superscript
    var stubVisitSuperscript =
        LINKER.upcallStub(
            LOOKUP.bind(
                this,
                "handleVisitSuperscript",
                MethodType.methodType(
                    int.class,
                    MemorySegment.class,
                    MemorySegment.class,
    ...
    off += ValueLayout.ADDRESS.byteSize();
    // visit_line_break
    var stubVisitLineBreak =
        LINKER.upcallStub(
            LOOKUP.bind(
                this,
                "handleVisitLineBreak",
                MethodType.methodType(
                    int.class,
                    MemorySegment.class,
                    MemorySegment.class,
    ...
    var stubVisitHorizontalRule =
        LINKER.upcallStub(
            LOOKUP.bind(
                this,
                "handleVisitHorizontalRule",
                MethodType.methodType(
                    int.class,
                    MemorySegment.class,
                    MemorySegment.class,
    ...
    var stubVisitCustomElement =
        LINKER.upcallStub(
            LOOKUP.bind(
                this,
                "handleVisitCustomElement",
                MethodType.methodType(
                    int.class,
                    MemorySegment.class,
                    MemorySegment.class,
    ...
    var stubVisitDefinitionListStart =
        LINKER.upcallStub(
            LOOKUP.bind(
                this,
                "handleVisitDefinitionListStart",
                MethodType.methodType(
                    int.class,
                    MemorySegment.class,
                    MemorySegment.class,
    ...
    var stubVisitDefinitionTerm =
        LINKER.upcallStub(
            LOOKUP.bind(
                this,
                "handleVisitDefinitionTerm",
                MethodType.methodType(
                    int.class,
                    MemorySegment.class,
                    MemorySegment.class,
    ...
    var stubVisitDefinitionDescription =
        LINKER.upcallStub(
            LOOKUP.bind(
                this,
                "handleVisitDefinitionDescription",
                MethodType.methodType(
                    int.class,
                    MemorySegment.class,
                    MemorySegment.class,
    ...
    var stubVisitDefinitionListEnd =
        LINKER.upcallStub(
            LOOKUP.bind(
                this,
                "handleVisitDefinitionListEnd",
                MethodType.methodType(
                    int.class,
                    MemorySegment.class,
                    MemorySegment.class,
  ...
  private long registerStubs4(final long offset) throws ReflectiveOperationException {
    ...
    off += ValueLayout.ADDRESS.byteSize();
    // visit_figure_start
    var stubVisitFigureStart =
        LINKER.upcallStub(
            LOOKUP.bind(
                this,
                "handleVisitFigureStart",
                MethodType.methodType(
                    int.class,
                    MemorySegment.class,
                    MemorySegment.class,
    ...
    off += ValueLayout.ADDRESS.byteSize();
    // visit_figcaption
    var stubVisitFigcaption =
        LINKER.upcallStub(
            LOOKUP.bind(
                this,
                "handleVisitFigcaption",
                MethodType.methodType(
                    int.class,
                    MemorySegment.class,
                    MemorySegment.class,
    ...
    off += ValueLayout.ADDRESS.byteSize();
    // visit_figure_end
    var stubVisitFigureEnd =
        LINKER.upcallStub(
            LOOKUP.bind(
                this,
                "handleVisitFigureEnd",
                MethodType.methodType(
                    int.class,
                    MemorySegment.class,
                    MemorySegment.class,
  ...
  int handleVisitLink(
    ...
    try (var encArena = Arena.ofConfined()) {
      ...
      var text = rawText0.reinterpret(Long.MAX_VALUE).getString(0);
      var title =
          rawTitle0.equals(MemorySegment.NULL)
              ? null
  ...
  int handleVisitHeading(
    ...
    try (var encArena = Arena.ofConfined()) {
      ...
      var text = rawText0.reinterpret(Long.MAX_VALUE).getString(0);
      var id =
          rawId0.equals(MemorySegment.NULL)
              ? null
              : rawId0.reinterpret(Long.MAX_VALUE).getString(0);
  ...
  int handleVisitCodeBlock(
    ...
    try (var encArena = Arena.ofConfined()) {
      var context = decodeNodeContext(ctx);
      var lang =
          rawLang0.equals(MemorySegment.NULL)
              ? null
              : rawLang0.reinterpret(Long.MAX_VALUE).getString(0);
  ...
  int handleVisitForm(
    ...
    try (var encArena = Arena.ofConfined()) {
      var context = decodeNodeContext(ctx);
      var action =
          rawAction0.equals(MemorySegment.NULL)
              ? null
              : rawAction0.reinterpret(Long.MAX_VALUE).getString(0);
      var method =
          rawMethod0.equals(MemorySegment.NULL)
              ? null
  ...
  int handleVisitInput(
    ...
    try (var encArena = Arena.ofConfined()) {
      ...
      var name =
          rawName0.equals(MemorySegment.NULL)
              ? null
              : rawName0.reinterpret(Long.MAX_VALUE).getString(0);
      var value =
          rawValue0.equals(MemorySegment.NULL)
              ? null
  ...
  int handleVisitAudio(
    ...
    try (var encArena = Arena.ofConfined()) {
      var context = decodeNodeContext(ctx);
      var src =
          rawSrc0.equals(MemorySegment.NULL)
              ? null
              : rawSrc0.reinterpret(Long.MAX_VALUE).getString(0);
  ...
  private static NodeContext decodeNodeContext(final MemorySegment ctxPtr) {
    ...
    String parentTag =
        parentTagPtr.equals(MemorySegment.NULL)
            ? null
  ...
  private static int encodeVisitResult(
      VisitResult result, MemorySegment outCustom, MemorySegment outLen, Arena encArena) {
