...
// alef:hash:acf248fdccdf7183433fd17beecf61626e282c3801a85d57148ceab636dd6467
    ...
    public static ConversionResult convert(final String html, final ConversionOptions options)
        ...
        try (var arena = Arena.ofConfined()) {
            ...
            if (NativeLib.HTM_OPTIONS_SET_VISITOR != null && options.visitor() != null) {
                var bridge = new VisitorHandleBridge(options.visitor());
                var bridgeSeg = bridge.toSegment(arena);
                NativeLib.HTM_OPTIONS_SET_VISITOR.invoke(cOptions, bridgeSeg);
            }
