...
// alef:hash:fa5a90c0c0c359a1b2f795bab9dc0394136f3dfa3c442aac5fc9bb7757882327
...
public final class HtmlToMarkdownRs {
    ...
    try (var arena = Arena.ofConfined()) {
      ...
      var coptions =
          coptionsJson != null
              ...
              : MemorySegment.NULL;
      var resultPtr =
          (MemorySegment) NativeLib.HTM_CONVERT.invoke(chtml, coptions, MemorySegment.NULL);
  ...
  public static ConversionResult convertWithVisitor(
      String html, ConversionOptions options, Visitor visitor) throws HtmlToMarkdownRsException {
    try (var arena = Arena.ofConfined();
      ...
      var visitorHandle =
          (MemorySegment) NativeLib.HTM_VISITOR_CREATE.invoke(bridge.callbacksStruct());
      ...
      try {
        var resultPtr =
            (MemorySegment)
                NativeLib.HTM_CONVERT_WITH_VISITOR.invoke(cHtml, optionsPtr, visitorHandle);
