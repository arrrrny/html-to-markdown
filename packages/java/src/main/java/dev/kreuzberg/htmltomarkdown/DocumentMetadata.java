...
// alef:hash:219f698cbc662617dc985334e941209883b16ef2b75cb33cb71653c434e9992f
 ...
 * <p># Examples
 *
 * <p>{@code }{@code } # use html_to_markdown_rs::metadata::DocumentMetadata; let doc =
 * DocumentMetadata { title: Some("My Article".to_string()), description: Some("A great article
 * about Rust".to_string()), keywords: vec!["rust".to_string(), "programming".to_string()],
 * ..Default::default() };
 *
 * <p>assert_eq!(doc.title, Some("My Article".to_string())); {@code }{@code }
 */
