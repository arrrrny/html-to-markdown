...
# alef:hash:e8335f02ed3b9f3ca2a8bc3e5031ea409376ca7b815b420955cea51f3a23beda
  ...
  use RustlerPrecompiled,
    ...
    force_build:
      System.get_env("HTML_TO_MARKDOWN_BUILD") in ["1", "true"] or
        Application.compile_env(:rustler_precompiled, [:force_build, :html_to_markdown], false) or
        Mix.env() in [:test, :dev],
